...
public interface OrdenWebService {
    ...
    @RequestWrapper(localName = "listarOrdenes", targetNamespace = "http://service.tienda.ws.promerica.com/", className = "com.promerica.ui.tienda.ws.ListarOrdenes")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "crearOrden", targetNamespace = "http://service.tienda.ws.promerica.com/", className = "com.promerica.ui.tienda.ws.CrearOrden")
    @ResponseWrapper(localName = "crearOrdenResponse", targetNamespace = "http://service.tienda.ws.promerica.com/", className = "com.promerica.ui.tienda.ws.CrearOrdenResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "buscarOrdenPorId", targetNamespace = "http://service.tienda.ws.promerica.com/", className = "com.promerica.ui.tienda.ws.BuscarOrdenPorId")
